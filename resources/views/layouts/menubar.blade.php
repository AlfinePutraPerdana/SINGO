  ...
  <aside class="main-sidebar sidebar-dark-danger elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('assets_be/dist/img/profile.png')}}" class="img-circle elevation-4" alt="User Image">
        </div>
        <div class="info">
           <a href="/{{ Auth::id() }}/profile" class="d-block">{{ Auth::user()->name }} - NGO</a>
        </div>
      </div>
...
<script>
    $(document).ready(function () {
      ...
      $('#penerima_manfaat').summernote({placeholder: 'Masukan Teks...'})
      $('#indikator_outcome').summernote({placeholder: 'Masukan Teks...'})
      $('#detail_kegiatan').summernote()
      $('#output').summernote()
      $('#income').summernote()
      $('#capaian').summernote()
      $('#peran').summernote()
