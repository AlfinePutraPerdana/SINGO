            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <article class="blog-post-wrapper">
                <div class="post-thumbnail">
                  <img src="{{ asset('assets_fe/img/blog/6.jpg')}}" alt="" />
                </div>
              ...
              <div class="single-post-comments">
                      ...
                      <li class="threaded-comments">
                        <div class="comments-details">
                          <div class="comments-list-img">
                            <img src="{{ asset('assets_fe/img/blog/b02.jpg')}}" alt="post-author">
                          </div>
                ...
                <div class="comment-respond">
                  <h3 class="comment-reply-title">Beri Komentar</h3>
                  <span class="email-notes">Alamat email tidak akan diperlihatkan. Anda harus mengisi kolom yang diberi tanda *</span>
                  <form action="#">
                    <div class="row">
                      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <p>Name *</p>
