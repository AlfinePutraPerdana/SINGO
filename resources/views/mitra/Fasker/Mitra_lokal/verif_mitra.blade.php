...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Verifikasi Mitra Lokal</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Verifikasi Mitra Lokal</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Pengajuan Mitra Lokal</h3>
                    ...
                    <div class="card-body table-responsive p-0" style="height: 450px;">
                        <form action="">
                            <table class="table table-head-fixed">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>Organisasi Lingkungan Hidup</td>
                                    <td>Bogor</td>
                                    <td>202100101</td>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="" method="post" class="contactForm">
                                                            <div class="form-group">
                                                                ...
                                                                <p>Organisasi Lingkungan Hidup</p>
                                                            </div>
                                                            <div class="form-group">
                                                                <h5>Negara Asal</h5>
                                                                <p>Bogor</p>
