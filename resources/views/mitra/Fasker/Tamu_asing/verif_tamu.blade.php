              ...
              <table class="table table-head-fixed">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Singapura</td>
                        <td>
                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#pratinjau">
                            <i class="far fa-eye" data-toggle="tooltip" title="Lihat form lengkap"></i>
                        </button></td>
                        <div class="modal fade" id="pratinjau" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                            <div class="modal-content">
