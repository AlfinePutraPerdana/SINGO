      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../RKT/rkt.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Rencana Kerja</p>
                </a>
              </li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Rekomendasi Tenaga Asing <a href="ajukantenaga.html" class="badge badge-pill badge-primary">Tambah Rekomendasi</a></h3>  
            ...
            <div class="card-footer clearfix">
              <div class="col-md-4 float-left">
                <a href="prosestenaga.html" role="button" class="btn btn-primary">Kirim Rekomendasi</a>
              </div>
