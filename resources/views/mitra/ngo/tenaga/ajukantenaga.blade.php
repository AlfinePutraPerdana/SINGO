                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    <label for="tanggal lahir">Tanggal Lahir</label>
                                        <input type="text" name="tanggal_lahir" id="tanggal lahir" placeholder="Tanggal Lahir" class="form-control datepicker datetimepicker-input" data-toggle="datetimepicker" data-target=".datepicker" value="{{old('tanggal_lahir')}}" required data-parsley-type="date" data-parsley-trigger="keyup"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="tgl_berlaku_awal" id="berlaku" placeholder="yy/mm/dd" class="form-control startdate2 datetimepicker-input" data-toggle="datetimepicker" data-target=".startdate2" value="{{old('tgl_berlaku_awal')}}"/>
                                        <div class="input-group-append">
                                        <span class="input-group-text">s/d</span>
                                        </div>
                                        <input type="text" name="tgl_berlaku_akhir" placeholder="yy/mm/dd" class="form-control enddate2 datetimepicker-input" data-toggle="datetimepicker" data-target=".enddate2" value="{{old('tgl_berlaku_akhir')}}" data-parsley-required data-parsley-type="date" data-parsley-trigger="keyup"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Mitra</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="tgl_awal" id="lama kegiatan" placeholder="yy/mm/dd" class="form-control startdate datetimepicker-input" data-toggle="datetimepicker" data-target=".startdate" value="{{old('tgl_awal')}}"/>
                                        <div class="input-group-append">
                                        <span class="input-group-text">s/d</span>
                                        </div>
                                        <input type="text" name="tgl_akhir" placeholder="yy/mm/dd" class="form-control enddate datetimepicker-input" data-toggle="datetimepicker" data-target=".enddate" value="{{old('tgl_akhir')}}" data-parsley-required data-parsley-type="date" data-parsley-trigger="keyup"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <input type="file" name="cv_resume" class="custom-file-input" id="cv" aria-describedby="cv" value="{{old('cv_resume')}}" data-parsley-required data-parsley-trigger="keyup">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="jobdesk">Lampirkan Jobdesk</label>
                                        <div class="custom-file">
                                            <input type="file" name="jobdesc" class="custom-file-input" id="jobdesk" aria-describedby="jobdesk" data-parsley-required data-parsley-trigger="keyup">
                                ...
                                <div class="form-group">
                                    <label for="dokumen">File Pendukung</label>
                                        <div class="custom-file">
                                            <input type="file" name="dokumen_pendukung" class="custom-file-input" id="dokumen" aria-describedby="dokumen" data-parsley-required data-parsley-trigger="keyup">
