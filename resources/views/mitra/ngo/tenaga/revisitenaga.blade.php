        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rekomendasi Tenaga Asing</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form role="form">
                ...
                <div class="card-footer">
                  <a class="btn btn-primary" href="tenaga.html" role="button">Simpan</a>
                </div>
              </form>
            </div>
          <!-- /.col-->
...
<script src="{{assets('assets_be/plugins/datepicker/libraries/tempusdominus/js/tempusdominus-bootstrap-4.min.js')}}"></script>
