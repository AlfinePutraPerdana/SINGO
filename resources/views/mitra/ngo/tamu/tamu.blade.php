        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Pemberitahuan Tamu Asing <span><a href="ajukantamu.html" class="badge badge-primary">Tambah Pemberitahuan Tamu</a></span></h3>  
              ...
              <table class="table table-head-fixed">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="revisitamu.html" class="badge badge-pill badge-primary">Ubah</a></td>
                    <td>
            ...
            <div class="card-footer clearfix">
              <div class="col-md-4 float-left">
                <button type="button" class="btn btn-primary">Kirim Pemberitahuan</button>
              </div>
