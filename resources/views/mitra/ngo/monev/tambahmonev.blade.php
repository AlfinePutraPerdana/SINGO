...
<head>
  ...
  <link rel="stylesheet" href="../../datepicker/libraries/tempusdominus/css/tempusdominus-bootstrap-4.min.css">
  <!-- Ionicons -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="draftrkt.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Rencana Kerja</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="prosesrktdraft.html" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sedang Proses</p>
                </a>
              </li>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" role="form">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleFormControlSelect1">Pillih Propinsi</label>
...
<script src="../../datepicker/libraries/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
