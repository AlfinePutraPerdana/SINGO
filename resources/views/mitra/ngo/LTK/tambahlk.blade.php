    ...
    <div class="row">
      <div class="col-md-12">
         <div class="card card-primary">
          ...
          <form action="/lk/store" role="form" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
            <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <input name="nominal_asing" type="number" class="form-control" placeholder="Masukan Nominal">
                  </div>
                </div>
                <div class="form-group mt-3">
                  <label for="">Pembiayaan(Rp)</label>
                  <input name="nominal_lokal" type="number" class="form-control" placeholder="Masukan Nominal">
                </div>
                <div class="form-group">
