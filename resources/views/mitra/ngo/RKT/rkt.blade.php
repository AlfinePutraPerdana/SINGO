...
<head>
  ...
  <title>Fakser | Rencana Kerja </title>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Draft Rencana Kerja Tahunan <a href="tambahrkt.html" class="badge badge-pill badge-primary">Tambah Draft</a></h3>  
              ...
              <table class="table table-head-fixed">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="revisirktdraft.html" class="badge badge-pill badge-primary">Ubah</a></td>
                    <td>
            ...
            <div class="card-footer clearfix">
              <div class="col-md-4 float-left">
                ...
                <a href="prosesrkt.html" role="button" class="btn btn-primary">Kirim</a>
              </div>
