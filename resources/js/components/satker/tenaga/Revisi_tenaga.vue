        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/satker/tenaga">Rekomendasi Tenaga Asing</a></li>
                ...
                <div class="card card-primary">
                    ...
                    <form role="form">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="/satker/tenaga" role="button"><i class="far fa-save"></i> <b>Simpan</b></a>
                            </div>
                        </div>
                    </form>
                </div>
